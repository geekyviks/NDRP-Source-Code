...
Citizen.CreateThread(function()
	while true do
		...
		if isCameraActive then
			DisableControlAction(2, 30, false)
			DisableControlAction(2, 31, false)
			DisableControlAction(2, 32, false)
			DisableControlAction(2, 33, false)
			DisableControlAction(2, 34, false)
			DisableControlAction(2, 35, false)
