...
Config.Models = {
	...
	van     = 'minivan',      -- Chinese car Wuling hong guang S1
	truck   = 'mule',
	vehDoor = {
		-- If this value is true, it will open the vehicle trunk when player remove the goods from the vehicle.
		usingTrunkForVan   = false,  -- If you using original game vehicle, set this to false
...
Config.Locales = {
	...
	["safe_deposit_withheld"]     = "Job failed, your safe deposit has been detain.",
	["delivery_point_reward"]     = "Delivery done, you received $",
	...
	["not_enough_money"]          = "Your have not enough bank money to pay the safe deposit",
}