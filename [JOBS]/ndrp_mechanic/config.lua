...
Config.CircleZones = {
    ScrapField = {coords = vector3(1557.56, 6624.1, 2.4)},
	SalvageField = {coords = vector3(-573.68, -1456.37, 10.29)}
}

Config.Zones = {

	MechanicActions = {
		Pos   = { x = -200.86, y = -1317.77, z = 30.09 },
	...
	Craft = {
		Pos   = { x = -227.49, y = -1327.48, z = 29.89 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 27
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -160.09, y = -1305.09, z = 31.4 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -180.1, y = -1287.73, z = 30.32 },
