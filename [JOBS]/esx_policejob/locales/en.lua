Locales['en'] = {
  ...
  ['armory'] = 'armory',
  ['open_armory'] = 'press ~INPUT_CONTEXT~ to access the Stash.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ['armory_weapontitle'] = 'armory - Buy weapon',
  ['armory_componenttitle'] = 'armory - Weapon attatchments',
  ['armory_bought'] = 'you bought an %s for ~r~$%s',
  ...
  ['license_revoked'] = 'your ~b~%s has been revoked!',
  ['licence_you_revoked'] = 'you revoked a ~b~%s which belonged to %s',
  ['no_players_nearby'] = 'there is no player(s) nearby!',
  ['being_searched'] = 'you are being searched by the ~b~Police',
  -- Vehicle interaction
  ...
  ['search_database_found'] = 'the vehicle is registered to ~b~%s',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'you confiscated %sx ~b~%s from ~b~%s',
  ['got_confiscated'] = '%sx ~b~%s were confiscated by %s',
  ['you_confiscated_account'] = 'You confiscated ~g~$%s (%s) from ~b~%s',
  ...
  ['have_withdrawn'] = 'you have withdrawn %sx ~b~%s',
  ['have_deposited'] = 'you have deposited %sx ~b~%s',
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ...
  ['you_stole'] = 'You stole %sx %s',
  ['steal'] = 'Steal %s',
  ['steal_weapon'] = 'Steal %s with %s bullets',
  ['being_looted'] = 'You are being searched',
  ['steal_inv'] = 'Steal %sx %s',
