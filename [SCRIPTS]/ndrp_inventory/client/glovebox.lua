...
AddEventHandler("esx_inventoryhud:openGloveboxInventory", function(data, blackMoney, inventory, weapons)
...
AddEventHandler("esx_inventoryhud:refreshGloveboxInventory", function(data, blackMoney, inventory, weapons)
	setGloveboxInventoryData(data, blackMoney, inventory, weapons)
end)
...
function openGloveboxInventory()
    ...
    SendNUIMessage({action = "display", type = "glovebox"})
