...
RegisterNetEvent("esx-scoreboard:RemovePlayer")
AddEventHandler("esx-scoreboard:RemovePlayer", function(data)
    ST.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("esx-scoreboard:AddPlayer")
AddEventHandler("esx-scoreboard:AddPlayer", function(data)
    ST.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("esx-scoreboard:RemoveRecent")
AddEventHandler("esx-scoreboard:RemoveRecent", function(src)
    ST.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("esx-scoreboard:AddAllPlayers")
AddEventHandler("esx-scoreboard:AddAllPlayers", function(data, recentData)
