...
RegisterServerEvent('esx-scoreboard:AddPlayer')
AddEventHandler("esx-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("esx-scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("esx-scoreboard:AddAllPlayers", source, data, recentData)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("esx-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("esx-scoreboard:RemoveRecent", -1, plyid)
end)
